...
class WideEventMetaTest {
    @Test
    fun `default version matches the composed initial definition version`() {
        assertEquals(WideEventMeta.DEFAULT_VERSION, WideEventMeta.versionFor(WideEventDefinition.Version.INITIAL))
    }
